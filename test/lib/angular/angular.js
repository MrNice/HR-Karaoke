 ...
 * 
 * <pre>
 * var karaoke = angular.module('karaoke', []);
 * karaoke.run(function($templateCache) {
 ...
 *
 * - your app is hosted at url `http://karaoke.example.com/`
 * - but some of your templates are hosted on other domains you control such as
 *   `http://srv01.assets.example.com/`,  `http://srv02.assets.example.com/`, etc.
 * - and you have an open redirect at `http://karaoke.example.com/clickThru?...`.
 *
 * Here is what a secure configuration for this scenario might look like:
 *
 * <pre class="prettyprint">
 *    angular.module('karaoke', []).config(function($sceDelegateProvider) {
 ...
 *        'http://karaoke.example.com/clickThru**']);
 *      });
 * </pre>
 */
...
<file name="index.html">
  <div ng-controller="karaokeController as myCtrl">
...
<file name="script.js">
  ...
  mySceApp.controller("karaokeController", function karaokeController($http, $templateCache, $sce) {
    var self = this;
 ...
 *
 * <pre class="prettyprint">
 *   angular.module('karaokeWithSceDisabledkaraoke', []).config(function($sceProvider) {
